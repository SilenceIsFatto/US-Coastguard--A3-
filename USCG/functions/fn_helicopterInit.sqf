...
mst_fnc_deployHelicopterHookH60 = {
	...
	_dummy setMass 1;
	_dummy attachTo [vehicle player, [1.405, 2.031, 0.49]];
	_dummy allowDamage false;
	
	// ampersand, you're a life saver
	
	hook = "vtx_hook" createVehicle position player;
	hook setPos (vehicle player modelToWorld [0,0,0]); // [3,2,-1]
	...
	_rope = ropeCreate [vehicle player, [1.402, 2.03, 0.45], _dummy, [0,0,0], 5];
